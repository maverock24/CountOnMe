...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const workoutMusic: Array<DataKey> = [
    ...
    { label: 'Breeze Groove', value: require('../assets/sounds/action_breeze-groove.mp3') },
    {
    ...
    { label: 'Enjoy long', value: require('../assets/sounds/action_enjoy_long.mp3') },
    { label: 'Fun Day', value: require('../assets/sounds/action_fun-day.mp3') },
    { label: 'Funny running', value: require('../assets/sounds/action_funny-running.mp3') },
    { label: 'Joyride', value: require('../assets/sounds/action_joyride-jamboree.mp3') },
    { label: 'Sunshine Whistle', value: require('../assets/sounds/action_sunshine-whistle.mp3') },
    { label: 'Dance Music', value: require('../assets/sounds/action_the-dance-music.mp3') },
    {
      label: 'Upbeat Electro Swing',
      value: require('../assets/sounds/action_upbeat_children-electro-swing.mp3'),
    },
    { label: 'Upbeat energetic', value: require('../assets/sounds/action_upbeat-energetic.mp3') },
    { label: 'Upbeat fun', value: require('../assets/sounds/action_upbeat-fun.mp3') },
    { label: 'Chill Beats', value: require('../assets/sounds/chill_beats.mp3') },
    { label: 'Breath of Life', value: require('../assets/sounds/chill_breath-of-life.mp3') },
    { label: 'Deep Meditation', value: require('../assets/sounds/chill_deep-meditation.mp3') },
    { label: 'Forest Melody', value: require('../assets/sounds/chill_forest-melody.mp3') },
    { label: 'Inner Peace', value: require('../assets/sounds/chill_inner-peace.mp3') },
    {
      label: 'Relax Sleep',
